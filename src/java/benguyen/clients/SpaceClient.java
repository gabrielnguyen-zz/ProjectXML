...
/**
 * Jersey REST client generated for REST resource:SpaceFacadeREST
 * [benguyen.models.space]<br>
 * USAGE:
 * <pre>
...
public class SpaceClient {
    ...
    private static final String BASE_URI = "http://localhost:45366/HouseRentingAnalysis/webresources";

    public SpaceClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("benguyen.models.space");
    }
    ...
    public List<Space> findAll_XML() throws ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(new GenericType<List<Space>>(){});
    }
    ...
    public <T> T createSpace_XML(Object requestEntity,Class<T> responseType) throws ClientErrorException {
        try {
